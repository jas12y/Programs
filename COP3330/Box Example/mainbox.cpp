...
{  
   ...
   Box mybox5(5);             // box of size five  with default border and fill 
   Box mybox10(10,'#','@'); 
   Box mybox39(39, '*','&'); 
   ...
   mybox41.Summary(); 
   //  cout << mybox1<< endl; 
   cout << "See if I can read one in " << endl ;
   Box MyBox99;
   cin >> MyBox99;
   MyBox99.Draw(); 
   if(mybox39 == mybox10) cout << "Box Equals" << endl; 
   else cout << "Not Equal" << endl;
   cout << "Copy Box1 to Box2" << endl;
   mybox2 = mybox1; 
   return 0;
}
