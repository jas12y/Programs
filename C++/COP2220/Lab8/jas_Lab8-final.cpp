    ...
    do
    {
         ...
         cin  >> choice;
              ...
              if (toupper(choice) == 'A')
              {
                    ...
                    {
                         logo();
                         summary("Standard", months, STANDARD);     
                    }
                    else
                    {
                         logo();
             ...
             else if (toupper(choice) == 'B')
             {
                    ...
                    {
                         logo();
                         summary("Student", months, STUDENT);
                    }
                    else
                    {
                         logo();
...
void summary(string type, int months, float rate)
{
